...
public class Library extends JFrame {
	...
	public Library() {
		...
		JLabel lblLibraryManagement = new JLabel("Ronneby Library Management");
		lblLibraryManagement.setFont(new Font("Verdana", Font.PLAIN, 18));
		...
		btnAdminLogin.setFont(new Font("Verdana", Font.PLAIN, 15));
		...
		btnLibrarianLogin.setFont(new Font("Verdana", Font.PLAIN, 15));
