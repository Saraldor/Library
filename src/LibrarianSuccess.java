...
public class LibrarianSuccess extends JFrame {
	...
	public LibrarianSuccess() {
		...
		JLabel lblLibrarianSection = new JLabel("Ronneby Librarian Section");
		lblLibrarianSection.setFont(new Font("Verdana", Font.PLAIN, 22));
		...
		btnViewBooks.setFont(new Font("Verdana", Font.PLAIN, 13));
		...
		btnIssueBook.setFont(new Font("Verdana", Font.PLAIN, 13));
		...
		btnViewIssuedBooks.setFont(new Font("Verdana", Font.PLAIN, 13));
		...
		btnReturnBook.setFont(new Font("Verdana", Font.PLAIN, 13));
