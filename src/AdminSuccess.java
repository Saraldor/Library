...
public class AdminSuccess extends JFrame {
	...
	public AdminSuccess() {
		...
		lblAdminSection.setFont(new Font("verdana", Font.PLAIN, 22));
		...
		btnViewLibrarian.setFont(new Font("Verdana", Font.PLAIN, 15));
		...
		btnDeleteLibrarian.setFont(new Font("Verdana", Font.PLAIN, 15));
